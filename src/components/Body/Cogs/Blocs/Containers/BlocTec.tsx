...
function BlocTec(props: {
  ...
  return (
    <motion.div
      ...
      initial="VariantA"
      whileHover="VariantB"
      data-testid="bloc-tec"
    >
      <button
        onClick={() => setPage()}
        className="h-[90px] w-[90px] bg-[linear-gradient(#FFFFFF_87%,_#9E0000_100%)] rounded-xl shadow-red m-2"
      >
        <div className="flex flex-col mb-2">
          <h1 className="text-black font-extrabold text-xs">{props.title}</h1>
          <img
