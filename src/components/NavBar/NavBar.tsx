    ...
    <header className={styles.NavBarBody}>
      <nav className={styles.NavBarContent}>
         <ul className="flex flex-row items-center">
          ...
          <button onClick={() => { window.open("https://www.linkedin.com/in/leonardo-mallet-65a19931a/")}}className={styles.ButtonStyle}> <img className="h-9 w-9" src="/assets/navbar/linkedin.png" alt="Linkedin" /></button>
          {/* <Options></Options> */}
         </ul>
        </nav>
    </header>
